...
const FIXTURE_ENDPOINT_DETAILS: Record<string, EndpointDetail> = {
  ep_demo_linux_01: {
    ...
    agent_version: "1.3.2",
    client_id: "cl_summitflow",
    location_id: "loc_sf_lon",
    tenant_id: "summit-corp",
    site_id: "sf-lon-dc",
    status: "active",
  ...
  ep_demo_windows_02: {
    ...
    agent_version: "1.3.1",
    client_id: "cl_acme",
    location_id: "loc_acme_ny",
    tenant_id: "acme-financial",
    site_id: "acme-ny-wallst",
    status: "active",
    connectivity_status: "degraded",
...
const FIXTURE_CLIENTS = [
  ...
  {
    client_id: "cl_vanguard",
    key: "vanguard-health",
    name: "Vanguard Health Alliance",
    state: "active",
    is_system: false,
    created_at: "2026-04-18T18:00:00Z",
    updated_at: "2026-04-18T18:00:00Z",
...
const FIXTURE_LOCATIONS = [
  ...
  {
    location_id: "loc_acme_chi",
    client_id: "cl_acme",
    key: "acme-chi-ops",
    name: "Chicago Operations Hub",
    state: "active",
    is_system: false,
    created_at: "2026-04-18T18:00:00Z",
    updated_at: "2026-04-18T18:00:00Z",
  ...
  {
    location_id: "loc_apex_dal",
    client_id: "cl_apex",
    key: "apex-dal-hub",
    name: "Dallas Fleet Terminal",
    state: "active",
    is_system: false,
    created_at: "2026-04-18T18:00:00Z",
    updated_at: "2026-04-18T18:00:00Z",

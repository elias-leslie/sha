...
export interface SourcePackDetail extends SourcePackSummary {
  ...
  controls: Array<{
    ...
    mappings: {
      cis_control_ids: string[];
      nist_csf_ids: string[];
      sp80053_ids: string[];
      legacy_sha_ids: string[];
    };
  }>;
}
  ...
  ep_demo_linux_01: {
    ...
    latest_results: [
      ...
      },
      {
        ...
        severity: "medium",
        evidence_summary: "Auditd rule coverage is missing file deletion telemetry for /srv/shared.",
        reboot_required: false,
      },
      {
    ...
    latest_results: [
      {
        ...
        status: "fail",
        current_value: "Shared local admin credential in rotation",
        recommended_value: "Per-device LAPS secret",
        severity: "high",
        evidence_summary: "Local admin rotation still uses a shared vault credential.",
        reboot_required: false,
      },
      {
